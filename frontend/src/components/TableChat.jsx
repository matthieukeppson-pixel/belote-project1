...
const SIMPLE_EMOJIS = [
  ...
  { code: ":chenille:", src: "/emojis/chenille-belote-et-amis.gif", alt: "chenille" },
  { code: ":peeker:", src: "/emojis/peeker-belote-et-amis.gif", alt: "peeker" },
];
      ...
      return (
        <span key={`emoji-${index}`} className="tablechat-custom-emoji-wrap">
          <img
            src={src}
            alt={clean}
            className={`tablechat-custom-emoji${clean === ":bonjour:" || clean === ":bonsoir:" ? " tablechat-custom-emoji--bonjour" : ""}`}
          />
        </span>
      );
    }
    ...
    {SIMPLE_EMOJIS.map((emoji) => (
      ...
      >
        <img
          src={emoji.src}
          alt={emoji.alt}
          className={`tablechat-emoji-btn-img${emoji.code === ":bonjour:" || emoji.code === ":bonsoir:" ? " tablechat-emoji-btn-img--bonjour" : ""}`}
        />
      </button>
    ))}
  </div>
